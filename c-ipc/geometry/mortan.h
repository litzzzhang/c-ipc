...
//
// Use of this source code is granted via a BSD-style license, which can be
// found in License.txt in the repository root.
//
...
class MortonCode64 {
  public:
    ...
    // Applies the bitshift to every dimension, assumes all entries to be
    // positive
...
inline const MortonCode64 MortonCode64::Zero(0u, 0u, 0u);
inline const MortonCode64 MortonCode64::UnitX(1u, 0u, 0u);
inline const MortonCode64 MortonCode64::UnitY(0u, 1u, 0u);
inline const MortonCode64 MortonCode64::UnitZ(0u, 0u, 1u);

inline uint64_t SplitBy3Bits21(int32_t x) {
...
inline int32_t CompactBy3Bits21(uint64_t x) {
...
inline MortonCode64::MortonCode64() {}

inline MortonCode64::MortonCode64(int32_t x, int32_t y, int32_t z) {
...
inline MortonCode64::MortonCode64(uint32_t x, uint32_t y, uint32_t z) {
    data =
        (SplitBy3Bits21(x) | SplitBy3Bits21(y) << 1 | SplitBy3Bits21(z) << 2) | 0x7000000000000000;
}

inline MortonCode64::MortonCode64(uint64_t d) : data(d) {}

inline void MortonCode64::decode(int32_t &x, int32_t &y, int32_t &z) const {
    // invert sign bits
...
inline int64_t xMask = 0x1249249249249249; // ...001001001001001001001

template <int DIM>
inline MortonCode64 MortonCode64::InvertDimension() const {
...
inline MortonCode64 MortonCode64::DivideDimensionBy2(int dim) const {
...
inline MortonCode64 MortonCode64::Negate() const {
...
inline MortonCode64 MortonCode64::operator+(const MortonCode64 rhs) const {
    // invert sign bits
...
inline MortonCode64 MortonCode64::operator+(const int64_t rhs) const { return MortonCode64(data + rhs); }

inline MortonCode64 &MortonCode64::operator+=(const MortonCode64 rhs) {
    *this = *this + rhs;
    return *this;
}

inline MortonCode64 MortonCode64::operator-(const MortonCode64 rhs) const { return *this + rhs.Negate(); }

inline MortonCode64 MortonCode64::operator>>(int shift) const {
    assert(data >> 60 == 7); // all signs must be positive
